...
const Header = () => {
  ...
  return (
    <header className='wrapper flex justify-center gap-10 p-5 bg-[#f8fafc]  ' >
      <div className='content max-w-7xl flex-1 flex justify-between gap-10  '>
        ...
        {currentUser ? (
          <div className='bannerNav flex items-center space-x-5 relative ' >
            ...
            <div className='cursor-pointer' >Forum</div>
            <div className='cursor-pointer' >Markertplace</div>
            <Link href={'/?addNew=true'}>
              <div className='cursor-pointer bg-[#16a34a] text-white py-2 px-4 rounded-lg' >Write</div>
            </Link>
            <button className='accentedButton bg-[#16a34a] text-white py-2 px-4 rounded-lg ' >Get Unlimited Access</button>
          ...
          <div className='bannerNav flex items-center space-x-5 ' >
            ...
            <button className='accentedButton  bg-[#16a34a] text-white py-2 px-4 rounded-lg ' >Get Started</button>
